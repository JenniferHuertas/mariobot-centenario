...
module.exports = [
    function (session) {
        ...
        (DialogLabels = {
            NumPartida: "Número de Partida",
            DesInmueble: "Descripción del Inmueble",
            Propietario: "Propietario",
        }),
            builder.Prompts.choice(
                session,
                "Estoy atento. Dime, ¿que deseas consultar?",
                [
                    DialogLabels.NumPartida,
                    DialogLabels.DesInmueble,
                    DialogLabels.Propietario,
                ],
                {
                    maxRetries: 3,
    ...
    function (session, result) {
        ...
        switch (selection) {
            case DialogLabels.NumPartida:
                return session.beginDialog("NumPartida");
            case DialogLabels.DesInmueble:
                return session.beginDialog("DesInmueble");
            case DialogLabels.Propietario:
                return session.beginDialog("Propietario");
        }
    },
